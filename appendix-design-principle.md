...
- [KISS: mantenlo simple](#kiss-mantenlo-simple)
- [SOLID](#solid)
  - [SRP: responsabilidad única](#srp-responsabilidad-única)
  - [OCP: abierto a la extensión](#ocp-abierto-a-la-extensión)
  - [LSP: sustitución de Liskov](#lsp-sustitución-de-liskov)
  - [ISP: segregación de interfaces](#isp-segregación-de-interfaces)
  - [DIP: inversión de dependencias](#dip-inversión-de-dependencias)
