...
- [¿Qué es `null`?](#qué-es-null)
  - [`null` no es lo mismo que `Unit`](#null-no-es-lo-mismo-que-unit)
- [Tipos que aceptan null](#tipos-que-aceptan-null)
- [El compilador te protege](#el-compilador-te-protege)
- [Herramientas para manejar null](#herramientas-para-manejar-null)
  - [La llamada segura `?.`](#la-llamada-segura-)
  - [El operador Elvis `?:`](#el-operador-elvis-)
  - [Comprobar con `if`](#comprobar-con-if)
  - [La aserción `!!`](#la-aserción-)
- [¿De dónde salen los valores null?](#de-dónde-salen-los-valores-null)
- [Resumen](#resumen)
