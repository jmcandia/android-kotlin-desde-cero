...
- [El problema: clases que solo guardan datos](#el-problema-clases-que-solo-guardan-datos)
- [La solución: `data class`](#la-solución-data-class)
  - [`toString()` legible](#tostring-legible)
  - [Comparación por contenido](#comparación-por-contenido)
  - [`copy()`: copias modificadas](#copy-copias-modificadas)
  - [Desestructuración](#desestructuración)
- [¿Cuándo usar una `data class`?](#cuándo-usar-una-data-class)
- [Resumen](#resumen)
...
<table style="width: 100%; border-collapse: collapse;">
    <tr>
        <td style="text-align: left;">
            <a href="/chapter17.md">← Anterior</a>
        </td>
        <td style="text-align: center;">
            <a href="/README.md">Ir al índice</a>
        </td>
        <td style="text-align: right;">
            <a href="/chapter19.md">Siguiente →</a>
        </td>
    </tr>
</table>
