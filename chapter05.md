...
- [Operadores aritméticos](#operadores-aritméticos)
  - [División entera y división decimal](#división-entera-y-división-decimal)
  - [El operador módulo (`%`)](#el-operador-módulo-)
  - [Orden de las operaciones](#orden-de-las-operaciones)
- [Operadores de asignación](#operadores-de-asignación)
  - [Asignación compuesta](#asignación-compuesta)
  - [Incremento y decremento](#incremento-y-decremento)
