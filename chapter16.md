...
- [Los pilares de la POO](#los-pilares-de-la-poo)
- [¿Qué es una clase?](#qué-es-una-clase)
- [Definir una clase y crear objetos](#definir-una-clase-y-crear-objetos)
- [Propiedades](#propiedades)
- [El constructor primario](#el-constructor-primario)
- [Valores por defecto en el constructor](#valores-por-defecto-en-el-constructor)
- [El bloque `init`](#el-bloque-init)
- [Funciones miembro (métodos)](#funciones-miembro-métodos)
- [Mutabilidad: ¿qué controla `val`?](#mutabilidad-qué-controla-val)
- [Resumen](#resumen)
...
<table style="width: 100%; border-collapse: collapse;">
    <tr>
        <td style="text-align: left;">
            <a href="/chapter15.md">← Anterior</a>
        </td>
        <td style="text-align: center;">
            <a href="/README.md">Ir al índice</a>
        </td>
        <td style="text-align: right;">
            <a href="/chapter17.md">Siguiente →</a>
        </td>
    </tr>
</table>
