...
- [Salida estándar](#salida-estándar)
  ...
  - [Impresión de números y caracteres](#impresión-de-números-y-caracteres)
  - [Plantillas de cadena](#plantillas-de-cadena)
- [Entrada estándar](#entrada-estándar)
  - [Uso de `readln`](#uso-de-readln)
    - [Leer valores `Int` y `Long`](#leer-valores-int-y-long)
