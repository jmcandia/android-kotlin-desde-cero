...
- [Android Studio, el IDE oficial de Android](#android-studio-el-ide-oficial-de-android)
- [Instalar Android Studio](#instalar-android-studio)
- [Crear tu primer proyecto](#crear-tu-primer-proyecto)
- [Anatomía de un proyecto Android](#anatomía-de-un-proyecto-android)
- [El AndroidManifest](#el-androidmanifest)
- [El código y `MainActivity`](#el-código-y-mainactivity)
- [Gradle y el catálogo de versiones](#gradle-y-el-catálogo-de-versiones)
...
<table style="width: 100%; border-collapse: collapse;">
    <tr>
        <td style="text-align: left;">
            <a href="/chapter24.md">← Anterior</a>
        </td>
        <td style="text-align: center;">
            <a href="/README.md">Ir al índice</a>
        </td>
        <td style="text-align: right;">
            <a href="/chapter26.md">Siguiente →</a>
        </td>
    </tr>
</table>
